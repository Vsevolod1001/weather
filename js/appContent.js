...
export const createContent = (data) => {
  ...
  const weatherInfoChangeOfRain = document.createElement("li");
  ...
  weatherInfoChangeOfRain.classList.add("weather-info__item");
  ...
  weatherInfoWind.append(
    ...
    createWeatherItemContent(
      data.wind.speed + " м/с, " + directionOfWind(data.wind.deg)
    )
  );
  ...
  weatherInfoChangeOfRain.append(
